    ...
    <div className="min-h-screen bg-white font-[Montserrat]">
      ...
      <section className="px-6 py-20 md:px-12 lg:px-24 bg-[#0F2D52]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link href="/essay-feedback">
            <button className="bg-white text-[#0F2D52] hover:bg-gray-100 font-bold py-4 px-10 rounded-lg text-lg transition-colors duration-200 shadow-lg hover:shadow-xl">
